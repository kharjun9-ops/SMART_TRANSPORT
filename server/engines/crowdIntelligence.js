    ...
    static calculateMultiStopCrowdForecast(tripId) {
        ...
        if (nextStop) {
            ...
            nextStopForecast = {
                ...
                wait_time_minutes: nextEta ? nextEta.eta_minutes : Math.max(1, (trip.delay_minutes || 0) + 4),
                arrival_time: nextEta ? nextEta.arrival_time : new Date(Date.now() + 4 * 60000).toISOString(),
        ...
        if (nextNextStop) {
            ...
            nextNextStopForecast = {
                ...
                wait_time_minutes: nextNextEta ? nextNextEta.eta_minutes : Math.max(3, (trip.delay_minutes || 0) + 10),
                arrival_time: nextNextEta ? nextNextEta.arrival_time : new Date(Date.now() + 10 * 60000).toISOString(),
